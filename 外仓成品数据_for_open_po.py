...
鄂成_Done = 鄂成_Done[["位置","批次/序列号码","可用数","单位","数量","预留数量"]]
...
津成_Done = 津成_Done[["位置","批次/序列号码","可用数","单位","数量","预留数量"]]
...
粤成_Done = 粤成_Done[["位置","批次/序列号码","可用数","单位","数量","预留数量"]]
...
# 粤成_Done_with_sumif = pd.merge(粤成_Done,grouped_粤成,how="left",left_on="产品/内部参考",right_on="产品/内部参考")
# 粤成_Done_with_sumif.to_excel(Output_path_粤成)
川成_Done = 川成_Done[["位置","批次/序列号码","可用数","单位","数量","预留数量"]]
...
def Condition_112(df_112):
    return  (df_112.loc[:,"位置"]!="YP-DJ")&\
            ...
            (~df_112.loc[:,"位置"].str.contains("退货"))&\
            (~df_112.loc[:,"位置"].str.contains("报废"))&\
